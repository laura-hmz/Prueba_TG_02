  ...
  return (
    <>
      ...
      <div className=" mx-auto ">
        <h1 className='text-sm ml-4 mt-2 mb-4 text-gray-500'> Puedes subir máximo 3 imagenes </h1>
      {images.length === 0 ? ( // Verifica si no hay imágenes
      <p className="text-center text-gray-600">No tienes fotos de tu servicio, ¿Qué esperas para subirlas?</p>
    ) : (
