...
const RoomServiceForm2 = ({service, option}) =>{
        ...
        <form  onSubmit={handleSubmit}>
            ...
            <div className={divDesing}>
                ...
                <div className={divEspace}>
                    <h1 className={tituloServicio}> {currentOption=== 'edit' ? 'Editar servicio de habitación' : 'Registrar servicio de habitación'} </h1>
                ...
                <div >
                    {currentOption !== 'show' && (
                        <button
                            ...
                            type="submit"
                        >
                            {currentOption === 'edit' ? 'Guardar cambios' : currentOption === 'register' ? 'Registrar servicio de habilitación' : ''}
                        </button>
                    )}
